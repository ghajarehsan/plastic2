    ...
    <div>
        ...
        <div class="content">
                ...
                <div class="d-flex mt-3 justify-content-center">
                    ...
                    <table class="  table-hover table-bordered" style="width: 90%">
                        ...
                        <tr v-for="(child , $index) in finaldata.childs">
                            ...
                            <td>
                                <router-link target="_blank" :to="'/productcomments/edit/'+child.id"
            ...
            <div class="d-flex justify-content-center mt-5">
                ...
                <p class="text-success mr-2 ml-2 ">{{finaldata.product}}</p>
            ...
            <div class="d-flex justify-content-around m-5">
                ...
                <span @click="getproductcomment()" class="brn btn-lg btn-primary" style="cursor: pointer">بروزرسانی</span>
        ...
        methods: {
            ...
            getproductcomment: function () {
                ...
                axios.post('/getproductcomment', {
                    ...
                    this.finaldata.product = response.data.product.name;
            ...
            savedata: function () {
                ...
                axios.post('/savedataproductcomment', {
