        ...
        <div class="content">
            ...
            <div class="filter-category">
                ...
                <div class="operation d-flex justify-content-end p-3 ">
                    ...
                    <span v-on:click="getallproductcomment()" class="btn btn-sm btn-outline-dark ml-2"
                    ...
                    <router-link :to="'/productcomments/edit/'+selectedid" target="_blank" :class="classObject2">
            ...
            <div class="main-content2">
                ...
                <div class="table-filter">
                    ...
                    <table class="table-bordered table-hover">
                        ...
                        <tr v-on:click="add($index,allproductcomment.id,allproductcomment.title)"
                            v-for="(allproductcomment ,$index) in allproductcomments"
                            :class="{'status':!allproductcomment.status}"
                            :key="$index">

                            <td>{{$index+1}}</td>
                            <td>{{allproductcomment.title}}</td>
                            <td style="min-width: 350px!important">{{allproductcomment.answer}}</td>
                            <td>{{allproductcomment.like}}</td>
                            <td>{{allproductcomment.user.name}}</td>
                            <td>{{allproductcomment.product.name}}</td>
                            <td>

                                <span v-if="allproductcomment.parent!==0" class="text-danger">پاسخ</span>
                            ...
                            <td>
                               ...
                               <span v-if="allproductcomment.status===1" class="text-success" style="font-size: 17px">
                            ...
                            <td>
                                ...
                                <span class="ml-2 ">{{allproductcomment.date}}</span>
                                <span class="text-danger">{{allproductcomment.hour}}</span>
...
<script>
    export default {
        ...
        mounted: function () {
            ...
            this.getallproductcomment();

        },

        methods: {

            getallproductcomment: function () {

                axios.post('/getallproductcomment').then(response => {

                    this.allproductcomments = response.data;
            ...
            deleteadvert: function (id) {
                ...
                axios.post('/deletproductcomment', {
