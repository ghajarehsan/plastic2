    ...
    export default {
        ...
        methods: {
            ...
            sendcomment: function () {
                ...
                axios.post('/sendcommentproduct', this.comment).then(response => {
            ...
            getallcomment: function () {
                ...
                axios.post('/getallcommentproduct', {
            ...
            addlike: function (id) {
                ...
                axios.post('/addlikecommentproduct', {
            ...
            sendanswer: function (id) {
                ...
                axios.post('/sendanswercommentproduct', {
