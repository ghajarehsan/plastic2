    ...
    export default {
        ...
        methods: {
            ...
            sendcomment: function () {
                ...
                axios.post('/sendcommentveblog', this.comment).then(response => {
            ...
            getallcomment: function () {
                ...
                axios.post('/getallcommentveblog', {
            ...
            addlike: function (id) {
                ...
                axios.post('/addlikecommentveblog', {
            ...
            sendanswer: function (id) {
                ...
                axios.post('/sendanswercommentveblog', {
