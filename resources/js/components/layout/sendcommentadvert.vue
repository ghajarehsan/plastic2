    ...
    export default {
        ...
        methods: {
            ...
            sendcomment: function () {
                ...
                axios.post('/sendcommentadvert', this.comment).then(response => {
            ...
            getallcomment: function () {
                ...
                axios.post('/getallcommentadvert', {
            ...
            addlike: function (id) {
                ...
                axios.post('/addlikecommentadvert', {
            ...
            sendanswer: function (id) {
                ...
                axios.post('/sendanswercommentadvert', {
